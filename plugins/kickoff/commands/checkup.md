...
4. Report a concise, prioritized "what to strengthen" — each item tagged (baseline vs discovered) and vetted (skills are lower-risk than plugins/MCP; flag anything account-backed). Present this **full plan for one approval** before writing or installing anything — don't act item-by-item.
